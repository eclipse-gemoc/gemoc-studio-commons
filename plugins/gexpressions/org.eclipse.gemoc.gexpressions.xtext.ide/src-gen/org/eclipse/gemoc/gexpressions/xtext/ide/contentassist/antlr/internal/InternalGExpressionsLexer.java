...
public class InternalGExpressionsLexer extends Lexer {
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3664:14: ( ( 'true' | 'false' ) )
            // InternalGExpressions.g:3664:16: ( 'true' | 'false' )
            {
            // InternalGExpressions.g:3664:16: ( 'true' | 'false' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalGExpressions.g:3664:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalGExpressions.g:3664:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3666:13: ( ( '-' | '+' )? ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' ) ( 'e' ( '-' | '+' ) RULE_INT )? )
            // InternalGExpressions.g:3666:15: ( '-' | '+' )? ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' ) ( 'e' ( '-' | '+' ) RULE_INT )?
            {
            // InternalGExpressions.g:3666:15: ( '-' | '+' )?
            int alt2=2;
            ...
            // InternalGExpressions.g:3666:26: ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' )
            int alt3=3;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalGExpressions.g:3666:27: RULE_INT '.' RULE_INT
                    {
                    mRULE_INT(); 
                    match('.'); 
                    mRULE_INT(); 
                    ...
                    break;
                case 2 :
                    // InternalGExpressions.g:3666:49: '.' RULE_INT
                    {
                    match('.'); 
                    mRULE_INT(); 
                    ...
                    break;
                case 3 :
                    // InternalGExpressions.g:3666:62: RULE_INT '.'
                    {
                    mRULE_INT(); 
                    match('.'); 
            ...
            // InternalGExpressions.g:3666:76: ( 'e' ( '-' | '+' ) RULE_INT )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalGExpressions.g:3666:77: 'e' ( '-' | '+' ) RULE_INT
                    {
                    match('e'); 
                    if ( input.LA(1)=='+'||input.LA(1)=='-' ) {
                        input.consume();
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3668:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalGExpressions.g:3668:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalGExpressions.g:3668:11: ( '^' )?
            int alt5=2;
            ...
            // InternalGExpressions.g:3668:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3670:10: ( ( '0' .. '9' )+ )
            // InternalGExpressions.g:3670:12: ( '0' .. '9' )+
            {
            // InternalGExpressions.g:3670:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalGExpressions.g:3670:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3672:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGExpressions.g:3672:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGExpressions.g:3672:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalGExpressions.g:3672:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGExpressions.g:3672:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalGExpressions.g:3672:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalGExpressions.g:3672:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalGExpressions.g:3672:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGExpressions.g:3672:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                        ...
                        switch (alt9) {
                    	case 1 :
                    	    // InternalGExpressions.g:3672:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalGExpressions.g:3672:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3674:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGExpressions.g:3674:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGExpressions.g:3674:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalGExpressions.g:3674:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3676:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGExpressions.g:3676:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGExpressions.g:3676:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
            ...
            // InternalGExpressions.g:3676:40: ( ( '\\r' )? '\\n' )?
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalGExpressions.g:3676:41: ( '\\r' )? '\\n'
                    {
                    // InternalGExpressions.g:3676:41: ( '\\r' )?
                    int alt13=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3678:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGExpressions.g:3678:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGExpressions.g:3678:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGExpressions.g:3680:16: ( . )
            // InternalGExpressions.g:3680:18: .
            {
            matchAny(); 
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "3666:26: ( RULE_INT '.' RULE_INT | '.' RULE_INT | RULE_INT '.' )";
        }
    }
